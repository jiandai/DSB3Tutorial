...
ver 20170406thu by jian: fork from LUNA_train_unet_exp_archi.py for batch training
ver 20170407fri.1 by jian: fork from LUNA_train_unet_btch.py to use a fixed lr
ver 20170407fri.2 by jian: fork from LUNA_train_unet_fixed_lr.py for small sample
to-do:
'''
...
h5file = 'unet-btch'+batch_char+'.hdf5'
prediction_file = 'masksTestPredicted-btch'+batch_char+'.npy'
